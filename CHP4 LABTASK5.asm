# Title: CHP4 LAB TASK 5
# Author: Daryll Anthony Fortunado
# Date: 
# Description:  asks the user to enter two positive numbers a and b and outputs the greatest common divisor of the two numbers by implementing the given algorithm.
